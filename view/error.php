...
<head>
    <title>Sistema | MCCPrinters</title><!-- [Meta] -->
    <meta charset="utf-8">
                    ...
                    <div class="card error-card">
                        <div class="card-body">
                            <div class="error-image-block"><img class="img-fluid"
                                    src="../assets/images/pages/img-error-404.svg" alt="img"></div>
                            <div class="text-center">
                                <h1 class="mt-5"><b>Acceso No Disponible</b></h1>
                                <p class="mt-2 mb-4 text-muted">
                                    La página a la que intenta acceder no está disponible.<br>
                                    Es posible que haya sido movida, eliminada o que no tenga los permisos necesarios para verla.
                                </p>
                                <a href="Dashboard/" class="btn btn-primary mb-3">Ir al Dashboard</a>
                            </div>
                        </div>
                    </div>
                </div>
